...
export default function ForbiddenState({
  ...
  return (
    <div className="relative flex min-h-[calc(100dvh-8rem)] flex-col overflow-hidden bg-surface-container-low">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-tertiary-container/50 via-surface-container-low to-surface-container-low"
      />
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pb-20 pt-10 text-center">
        <p className="select-none text-7xl font-semibold tracking-tight text-outline-variant/50 sm:text-8xl">403</p>
