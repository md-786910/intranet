...
const roleDefinitions = [
  {
    code: 'OWNER',
    name: 'Owner',
    description: 'Full platform owner with all permissions. Cannot be deleted or renamed.',
    is_system: true,
  ...
  },
  {
    ...
    is_system: false,
    permissions: [
      'ADMIN:MANAGE_VERTICALS', 'ADMIN:MANAGE_DEPARTMENTS', 'ADMIN:MANAGE_USERS', 'ADMIN:VIEW_ANALYTICS',
      ...
      'DIRECTORY:VIEW', 'DIRECTORY:MANAGE_PROFILE',
      'ANALYTICS:VIEW',
    ],
  },
  {
  ...
  },
  {
    ...
    permissions: [
      ...
      'DIRECTORY:VIEW',
      'SEARCH:QUERY',
      'SAVED:VIEW', 'SAVED:SAVE', 'SAVED:REMOVE',
    ],
  },
];
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    for (const def of roleDefinitions) {
      ...
      // Resolve permissions
      const targetActionIds = def.permissions === 'ALL'
        ? allActionIds
        : def.permissions
