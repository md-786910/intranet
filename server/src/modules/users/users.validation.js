...
const createUserSchema = {
  body: Joi.object({
    ...
    scope_type: scopeTypePattern.optional(),
    scope_id: idPattern.optional(),
    azure_object_id: Joi.string().trim().max(64).optional().allow('', null),
    skip_email: Joi.boolean().optional(),
    profile: Joi.object({
      ...
      employee_type: Joi.string().trim().max(100).optional().allow('', null),
      company_name: Joi.string().trim().max(255).optional().allow('', null),
      company_node_id: idPattern.optional().allow(null),
      office_node_id: idPattern.optional().allow(null),
      department_display: Joi.string().trim().max(255).optional().allow('', null),
